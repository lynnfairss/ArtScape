package com.example.nim234311044.artscape
...
import com.example.nim234311044.artscape.ui.theme.ArtScapeTheme
...
fun ArtScapeApp(modifier: Modifier = Modifier) {
    ...
    val titles = listOf("The waist game aesthetics", "The aesthetic natural forest views", "The traditional house pictures")
    val artists = listOf("Created by jimenez (2023)", "Created by wiliam genius (2018)", "Benny wahyu S (2020)")
